...
public class FailureDetectorManager
{
    ...
    @VisibleForTesting
    public static Map<String, Properties> getAvailableFrConfigs()
    {
    ...
    @VisibleForTesting
    public static void removeallFailureRetryFactory()
    {
        failureRetryFactories.clear();
    }

    @VisibleForTesting
    public static void removeallFailureDetectors()
    {
        failureDetectors.clear();
    }

    @VisibleForTesting
    public static void removeallFrConfigs()
    {
        availableFrConfigs.clear();
    }

    @VisibleForTesting
    public static void addFrConfigs(String profileName, Properties properties)
    {
