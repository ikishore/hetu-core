...
select  count(*)  from memory.default.store_sales, memory.default.household_demographics, memory.default.item, memory.default.income_band, memory.default.customer  where ss_hdemo_sk=hd_demo_sk and ss_item_sk=i_item_sk  and ib_income_band_sk = hd_income_band_sk and ss_customer_sk=c_customer_sk and hd_dep_count >=6  and i_manager_id >= 60;
