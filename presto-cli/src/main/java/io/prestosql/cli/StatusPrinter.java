    ...
    public void printFinalInfo()
    {
        ...
        if (debug) {
            ...
            if (snapshotStats != null) {
                ...
                String captureSummary = String.format("Snapshot capture stats All: %s/%.1fs/%.1fs, Last: %s/%.1fs/%.1fs",
                ...
                if (restoreCount > 0) {
                    ...
                    String restoreSummary = String.format("Snapshot restore stats %d/%s/%.1fs/%.1fs", restoreCount,
